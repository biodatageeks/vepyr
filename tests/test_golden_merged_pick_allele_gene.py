"""Integration test: compare --pick_allele_gene annotation against Ensembl VEP output."""
...
PICK_ALLELE_GENE_GOLDEN_DIR = TESTS_DIR / "data" / "golden_merged_pick_allele_gene"
