# Fast Annotation Report: chr1_chr22 (parquet, release 116, profile refseq)

**Date:** 2026-07-29 22:43
**Variants:** 4,096,123 (HG002 GRCh38, bcftools norm -m -both)
**Backend:** parquet only
**Total annotation time:** 200s (3.3 min)
**Aggregate rate:** 20,532 variants/s
...
**Validated cache:** release `116`, source `refseq` (contig-local Parquet metadata)
**Native target:** VEP `116.0`, semantics `116`, cache `116`

## Headline

- **85 / 85 CSQ fields at 100% match** (0 mismatches)
...
|-------|----------|----------|------------|
| chr1 | 323,430 | 17.2 | 18,804 |
| chr2 | 331,324 | 16.7 | 19,840 |
| chr3 | 288,531 | 19.0 | 15,186 |
| chr4 | 307,295 | 15.8 | 19,449 |
| chr5 | 264,411 | 15.6 | 16,949 |
| chr6 | 271,966 | 10.7 | 25,417 |
| chr7 | 234,522 | 9.9 | 23,689 |
| chr8 | 225,240 | 13.9 | 16,204 |
| chr9 | 176,111 | 7.4 | 23,799 |
| chr10 | 213,466 | 8.4 | 25,413 |
| chr11 | 206,822 | 8.7 | 23,773 |
| chr12 | 197,815 | 10.5 | 18,840 |
| chr13 | 161,419 | 6.3 | 25,622 |
| chr14 | 133,199 | 5.7 | 23,368 |
| chr15 | 125,179 | 5.3 | 23,619 |
| chr16 | 123,358 | 5.3 | 23,275 |
| chr17 | 108,376 | 5.4 | 20,070 |
| chr18 | 119,383 | 4.8 | 24,871 |
| chr19 | 90,699 | 4.4 | 20,613 |
| chr20 | 86,904 | 3.7 | 23,488 |
| chr21 | 55,812 | 2.5 | 22,325 |
| chr22 | 50,861 | 2.3 | 22,113 |
| **TOTAL** | **4,096,123** | **199.5** | **20,532** |
...
|-------|----------------------:|
| `both_empty` | 1,149,185,338 |
| `both_nonempty_equal` | 829,150,647 |
| `vepyr_empty_only` | 0 |
| `vep_empty_only` | 0 |
