# Fast Annotation Report: chr1_chr22 (parquet, release 116, profile merged)

**Date:** 2026-07-30 12:17
**Variants:** 4,096,123 (HG002 GRCh38, bcftools norm -m -both)
**Backend:** parquet only
**Total annotation time:** n/a (all output reused)
**Build:** branch `release-testing` @ `cb964bb16d21`, bio-functions rev `b4996420cea2`
**Cargo.lock SHA-256:** `d4ab132f22f19c1d91f8c8c4e99a04ad8f3641a9872dec2b5f3cba9e61236fff`
**datafusion-bio-format-core:** `6564554619019535ffd3ace5aa650797a31eb8ed`; effective source `git+https://github.com/biodatageeks/datafusion-bio-formats.git?tag=v1.9.0#6564554619019535ffd3ace5aa650797a31eb8ed`
**datafusion-bio-format-ensembl-cache:** `6564554619019535ffd3ace5aa650797a31eb8ed`; effective source `git+https://github.com/biodatageeks/datafusion-bio-formats.git?tag=v1.9.0#6564554619019535ffd3ace5aa650797a31eb8ed`
**datafusion-bio-format-vcf:** `6564554619019535ffd3ace5aa650797a31eb8ed`; effective source `git+https://github.com/biodatageeks/datafusion-bio-formats.git?tag=v1.9.0#6564554619019535ffd3ace5aa650797a31eb8ed`
**datafusion-bio-function-vep:** `b4996420cea2dc2d2b33b35ef75dcdafc553b376`; effective source `git+https://github.com/biodatageeks/datafusion-bio-functions.git?rev=b4996420cea2dc2d2b33b35ef75dcdafc553b376#b4996420cea2dc2d2b33b35ef75dcdafc553b376`
**VEP reference:** VEP `116.0`, API `116`, cache `116`, Ensembl `116.c0cf13d`, variation `116.2fb834b`
**Validated cache:** release `116`, source `merged` (contig-local Parquet metadata)
**Native target:** VEP `116.0`, semantics `116`, cache `116`

## Headline

- **86 / 86 CSQ fields at 100% match** (0 mismatches)
...
|-------|----------------------:|
| `both_empty` | 3,246,318,505 |
| `both_nonempty_equal` | 2,713,460,253 |
| `vepyr_empty_only` | 0 |
| `vep_empty_only` | 0 |
