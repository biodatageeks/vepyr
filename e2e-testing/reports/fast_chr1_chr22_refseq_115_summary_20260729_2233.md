# Fast Annotation Report: chr1_chr22 (parquet, release 115, profile refseq)

**Date:** 2026-07-29 22:33
**Variants:** 4,096,123 (HG002 GRCh38, bcftools norm -m -both)
**Backend:** parquet only
**Total annotation time:** 177s (2.9 min)
**Aggregate rate:** 23,181 variants/s
...
**Validated cache:** release `115`, source `refseq` (contig-local Parquet metadata)
...
|-------|----------|----------|------------|
| chr1 | 323,430 | 14.0 | 23,102 |
| chr2 | 331,324 | 13.8 | 24,009 |
| chr3 | 288,531 | 11.8 | 24,452 |
| chr4 | 307,295 | 14.8 | 20,763 |
| chr5 | 264,411 | 10.6 | 24,944 |
| chr6 | 271,966 | 10.8 | 25,182 |
| chr7 | 234,522 | 10.1 | 23,220 |
| chr8 | 225,240 | 9.4 | 23,962 |
| chr9 | 176,111 | 7.7 | 22,872 |
| chr10 | 213,466 | 9.1 | 23,458 |
| chr11 | 206,822 | 8.5 | 24,332 |
| chr12 | 197,815 | 8.4 | 23,549 |
| chr13 | 161,419 | 6.7 | 24,092 |
| chr14 | 133,199 | 6.7 | 19,880 |
| chr15 | 125,179 | 5.3 | 23,619 |
| chr16 | 123,358 | 5.6 | 22,028 |
| chr17 | 108,376 | 5.4 | 20,070 |
| chr18 | 119,383 | 4.9 | 24,364 |
| chr19 | 90,699 | 4.3 | 21,093 |
| chr20 | 86,904 | 3.8 | 22,869 |
| chr21 | 55,812 | 2.5 | 22,325 |
| chr22 | 50,861 | 2.5 | 20,344 |
| **TOTAL** | **4,096,123** | **176.7** | **23,181** |
...
|-------|----------------------:|
| `both_empty` | 1,142,128,579 |
| `both_nonempty_equal` | 823,455,111 |
| `vepyr_empty_only` | 0 |
| `vep_empty_only` | 0 |
