# Fast Annotation Report: chr1_chr22 (parquet, release 115, profile merged)

**Date:** 2026-07-30 12:06
...
**Validated cache:** release `115`, source `merged` (contig-local Parquet metadata)
...
|-------|----------------------:|
| `both_empty` | 2,752,896,309 |
| `both_nonempty_equal` | 2,279,602,499 |
| `vepyr_empty_only` | 0 |
| `vep_empty_only` | 0 |
